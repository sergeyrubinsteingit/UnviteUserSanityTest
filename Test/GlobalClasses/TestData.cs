...
namespace Test.GlobalClasses
{
    class TestData
    {
        ...
        public enum KeyWords
        {
            ...
            INVITE_USER_LOG_BOX, NOTIF_SUCCESS, NOTIF_ERROR, INVITE_USER_CAPTCHA_BOX, INVITE_USER_CAPTCHA_CHECKMARK, 
            INVITE_USER_CONTINUE_BUTTON, INVITE_USER_CAPTCHA_SPINNER, INVITE_USER_USER_PASSWORD_FIELD, 
            INVITE_USER_PASSWORD_MATCH, INVITE_USER_IS_TERMS_AND_CONDITIONS, INVITE_USER_PASSWORD, INVITE_USER_USER_FIRSTNAME,
