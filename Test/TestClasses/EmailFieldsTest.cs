...
{
        static readonly string[] emailEmpty = new[] { GlobalClasses.TestData.TestKeyValues[GlobalClasses.TestData.KeyWords.INVITE_USER_EMAIL], " ", "//*[@id=\"details\"]/div/div[2]/table/tbody/tr[1]/td[2]/span", "Email is required" };
        static readonly string[] verifyEmailEmpty = new[] { GlobalClasses.TestData.TestKeyValues[GlobalClasses.TestData.KeyWords.INVITE_USER_VERIFY_EMAIL], " ", "//*[@id=\"details\"]/div/div[2]/table/tbody/tr[2]/td[2]/span", "Verify Email is required" };
        ...
        public static void UserEmails() {
            ...
            for (int i = 0; i < emailValidationData.Length; i++) {
                ...
                // clicks outside the field to trigger a warning message underneath it
